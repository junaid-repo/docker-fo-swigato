...
public class ApiCalls {
	...
	public Map<String, Object> getProductDetails(String id) {
		...
		String uri = "http://" + "host.docker.internal:8086" + "/resturant/get/foodDetails/";
	...
	public Map<String, Object> getAddress(Integer id) {
		String uri = "http://" + "host.docker.internal:8087" + "/customer/view/address?id=";
	...
	public Map<String, Object> getCustomerDetails(String userCode) {
		String uri = "http://" + "host.docker.internal:8087" + "/customer/view/customerDetails?userCode=";
