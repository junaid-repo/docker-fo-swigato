...
public class ApiCalls {
	...
	public Map<String, Object> getProductDetails(String id) {
		...
		String uri = "http://" + "host.docker.internal:8092" + "/resturant/get/foodDetails/";
	...
	public Map<String, Object> getAddress(Integer id) {
		String uri = "http://" + "host.docker.internal:8093" + "/customer/view/address?id=";
	...
	public Map<String, Object> getCustomerDetails(String userCode) {
		String uri = "http://" + "host.docker.internal:8093" + "/customer/view/customerDetails?userCode=";
